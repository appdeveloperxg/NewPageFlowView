...
- (void)viewDidLoad {
    ...
    for (int index = 0; index < 10; index++) {
        NSString * str = [NSString stringWithFormat:@"Yosemite%02d",index];
...
- (void)setupUI {
    ...
    NewPagedFlowView *pageFlowView = [[NewPagedFlowView alloc] initWithFrame:CGRectMake(0, 8, Width, 100)];
...
- (UIView *)flowView:(NewPagedFlowView *)flowView cellForPageAtIndex:(NSInteger)index{
    ...
    if (!bannerView) {
        ...
        bannerView.layer.cornerRadius = 50;
